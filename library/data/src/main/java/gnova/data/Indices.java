...
public interface Indices<E>
    ...
    class QueryResult<E> {
         ...
         * 连接操作符
         */
        private final LogicalPredicate link;
        ...
        /**
         * 构造一个索引的集合
         * @param left 已经完成的匹配，允许为null
         * @param link 连接操作符，允许为null
         * @param right 未经完成的匹配，允许为null
         */
        public QueryResult(Iterator<E> left,
                           LogicalPredicate link,
         ...
         * @return
         */
        public LogicalPredicate getLink() {
            return link;
        }
     ...
     */
    void replace(@NotNull E before, @NotNull E after);
     ...
     */
    @NotNull
    QueryResult<E> query(@Checked PredicateExpression expression);
