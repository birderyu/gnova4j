...
import gnova.query.expression.util.Expressions;
...
public class ListRows<E extends Getter>
    ...
    public Iterator<E> rowIterator(String selection, Object[] params) {
        PredicateExpression le = Expressions.toPredicate(selection, params);
        return new PredicateIterator<>(rowIterator(), o -> le.match(o));
    }
